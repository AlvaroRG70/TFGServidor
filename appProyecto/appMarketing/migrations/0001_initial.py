# Generated by Django 3.2.25 on 2024-04-22 10:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedidos', models.ManyToManyField(through='appMarketing.DetallesCarrito', to='appMarketing.Pedido')),
            ],
        ),
        migrations.CreateModel(
            name='Resenias',
        ...
        migrations.AddField(
            ...
            name='pedido',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appMarketing.pedido'),
        ),
        migrations.AddField(
            model_name='detallescarrito',
            name='servicio',
